...
exports.articles = exports.links = exports.menu = exports.user = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = require("path");
const postsDirectory = path_1.join(process.cwd(), 'src', 'data', 'mdfiles');
const fullPath = path_1.join(postsDirectory, 'flowers.md');
